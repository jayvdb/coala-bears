...
class MainTest(unittest.TestCase):
    ...
    UPLOAD_BEAR_PATH = os.path.join(BEARS_PATH, 'upload')
    CSS_BEAR_SETUP_PATH = os.path.join(
        UPLOAD_BEAR_PATH, 'CSSLintBear', 'setup.py')
    ...
    def test_main(self):
        main()
        self.assertTrue(os.path.exists(self.UPLOAD_BEAR_PATH))
    ...
    def test_no_bear_object(self):
        ...
        self.assertFalse(os.path.exists(os.path.join(
            self.BEARS_PATH, 'upload', 'BadBear')))
        shutil.rmtree(os.path.join(self.BEARS_PATH, 'BadBear'))

    def tearDown(self):
        shutil.rmtree(os.path.join(self.BEARS_PATH, 'upload'))

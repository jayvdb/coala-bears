...
# Dart Lint commands
time wget -nc -O ~/dart-sdk.zip https://storage.googleapis.com/dart-archive/channels/stable/release/1.14.2/sdk/dartsdk-linux-x64-release.zip
time unzip -n ~/dart-sdk.zip -d ~/

...
# Dart Lint commands
time wget -q -nc -O ~/dart-sdk.zip https://storage.googleapis.com/dart-archive/channels/stable/release/1.14.2/sdk/dartsdk-linux-x64-release.zip
time unzip -qq -n ~/dart-sdk.zip -d ~/

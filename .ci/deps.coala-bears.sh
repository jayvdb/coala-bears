...
java -cp ~/.local/share/coala-bears/CheckstyleBear/checkstyle-6.15.jar com.puppycrawl.tools.checkstyle.Main -c /google_checks.xml tests/java/test_files/CheckstyleGood.java
java -cp ~/.local/share/coala-bears/CheckstyleBear/checkstyle-6.15.jar com.puppycrawl.tools.checkstyle.Main -c /google_checks.xml tests/java/test_files/CheckstyleBad.java
